...
<div class="container bg-primary mt-lg-5">
    <div class="offset-md-3 col-md-6 mt-t pl-3 bg-primary rounded shadow-1g">
        <h1 class="mt-2 pt-5 text-center text-white">Update Profile</h1>

        <form id="login-form" method="POST" action="../backend/update_profile.php" role="form">
            ...
            <button class="btn btn-info mt-5 bg-light mb-3 w-100" type="submit" name = "submit">Update Profile</button>

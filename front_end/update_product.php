...
<body class="bg-dark">
  ...
  <div class="container bg-primary mt-lg-5">
    <div class="offset-md-3 col-md-6 mt-t pl-3 bg-primary rounded shadow-1g">
      <h1 class="mt-2 pt-5 text-center font-italic text-white">Update Product</h1>
      <form id="login-form" method="post" action="../backend/update_product.php?prodID='.$pid.'" role="form">
        ...
        <div class="input-group mt-2 mb-2 shadow-sm">
          ...
          <input id="product-name" name="prodName" type="text" class="form-control" placeholder="Product Name" required="">
        </div>
        <label class="text-white form-check-label" for="description">Product Description:</label>
        <div class="input-group mt-2 mb-2 shadow-sm">
          <span class="input-group-text fa-solid fa-pen"></span>
          <input id="description" name ="prodDesc" type="text" class="form-control" placeholder="Product Description" required="">
        </div>
        <label class="text-white form-check-label" for="description">Product Image:</label>
        <div class="input-group mt-2 mb-2 shadow-sm">
          <input id="image" type="file" name="product-image" class="form-control" placeholder="Product Description">
        </div>
        <label class="text-white form-check-label" for="category">Category:</label>
        <div class="input-group mt-2 mb-2 shadow-sm">
          <span class="input-group-text fa-solid fa-folder"></span>
          <select id="category" name="prodCat" type="text" class="form-control" required="">
        ...
        <div class="input-group mt-2 mb-2 shadow-sm">
          ...
          <input id="price" name = "prodPrice" type="number" class="form-control" placeholder="Price" required="" min="0" max="1000000">
        </div>
        <label class="text-white form-check-label" for="stock">Inventory Count:</label>
        <div class="input-group mt-2 mb-2 shadow-sm">
          <span class="input-group-text fa-solid fa-money-bill"></span>
          <input id="stock" type="number" name = "prodCount" class="form-control" placeholder="Inventory Count" required="" min="0" max="1000000">
        </div>
        <div class="text-center">
          <div class="btn-group center-text">
            <a href="dashboard.php" class="btn ml-5 mt-5 mb-3 btn-danger">Cancel</a>
